...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpaceStation_Statics::NewProp_SpawnPoint_MetaData[] = {
		{ "Category", "Components" },
		{ "Comment", "/// TO parent comp\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "SpaceStation.h" },
		{ "ToolTip", "TO parent comp" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASpaceStation_Statics::NewProp_SpawnPoint = { "SpawnPoint", nullptr, (EPropertyFlags)0x00100000000a001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ASpaceStation, SpawnPoint), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ASpaceStation_Statics::NewProp_SpawnPoint_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASpaceStation_Statics::NewProp_SpawnPoint_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpaceStation_Statics::NewProp_GravityCollisionZone_MetaData[] = {
		{ "Category", "Gravity" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "SpaceStation.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASpaceStation_Statics::NewProp_GravityCollisionZone = { "GravityCollisionZone", nullptr, (EPropertyFlags)0x00100000000a001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ASpaceStation, GravityCollisionZone), Z_Construct_UClass_USphereComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ASpaceStation_Statics::NewProp_GravityCollisionZone_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASpaceStation_Statics::NewProp_GravityCollisionZone_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASpaceStation_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpaceStation_Statics::NewProp_SpawnPoint,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpaceStation_Statics::NewProp_GravityCollisionZone,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_romar_Documents_Unreal_Projects_APS_APS_ALPHA_Source_APS_ALPHA_SpaceStation_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASpaceStation, ASpaceStation::StaticClass, TEXT("ASpaceStation"), &Z_Registration_Info_UClass_ASpaceStation, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASpaceStation), 2730634907U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_romar_Documents_Unreal_Projects_APS_APS_ALPHA_Source_APS_ALPHA_SpaceStation_h_1116980792(TEXT("/Script/APS_ALPHA"),
