...
struct FFlightParams
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite) // SpaceshipOnboardComputer::GetEngineThrustForce
        double ThrustForce;
...
public:
    ...
    UPROPERTY()
        TMap<EFlightMode, FFlightParams> FlightModeParams =
        {
            ...
            {EFlightMode::Orbital, FFlightParams(1000, 0.05, 0.16)},
            //{EFlightMode::Orbital, FFlightParams(9000, 0.05, 0.16)},
            {EFlightMode::Planetary, FFlightParams(10000, 0.06, 0.2)},
            {EFlightMode::Interplanetary, FFlightParams(100000, 0.07, 0.24)},
