...
private:
	...
	EOrbitDistributionType ChooseDistributionType(EStellarType StellarClass, float StarMass, float MinOrbit,
	                                              float MaxOrbit);
	...
	const TMap<EPlanetType, FRadiusRange> PlanetRadiusRanges =
	{
		...
		{EPlanetType::Rocky, FRadiusRange(0.5, 0.9)}, // ���������
		{EPlanetType::Greenhouse, FRadiusRange(0.9, 1.1)}, // ����������
		{EPlanetType::Melted, FRadiusRange(0.6, 1.1)}, // �������������
		{EPlanetType::HotGiant, FRadiusRange(9.4, 12.6)}, // ������� �������
		{EPlanetType::GasGiant, FRadiusRange(7.9, 11.0)}, // ������� �������
		{EPlanetType::IceGiant, FRadiusRange(3.1, 7.9)}, // ������� �������
		{EPlanetType::Dwarf, FRadiusRange(0.2, 0.5)}, // ���������� �������
		{EPlanetType::Exoplanet, FRadiusRange(0.2, 3)}, // �����������
		{EPlanetType::Rogue, FRadiusRange(0.2, 2)}, // �������� �������
		{EPlanetType::Ocean, FRadiusRange(0.8, 1.1)}, // ������������ �������
		{EPlanetType::Desert, FRadiusRange(0.8, 1.1)}, // ��������� �������
		{EPlanetType::Forest, FRadiusRange(0.9, 1.3)}, // ������ �������
		{EPlanetType::Volcanic, FRadiusRange(0.8, 1.1)}, // ������������� �������
		{EPlanetType::Ice, FRadiusRange(0.3, 0.8)}, // ������� �������
		{EPlanetType::Frozen, FRadiusRange(0.3, 0.8)}, // ������������ �������
		{EPlanetType::Ammonia, FRadiusRange(0.6, 0.9)}, // ������� �������
		{EPlanetType::Metal, FRadiusRange(0.8, 1.1)}, // �������� �������
		{EPlanetType::Carbon, FRadiusRange(0.8, 1.1)}, // ���������� �������
