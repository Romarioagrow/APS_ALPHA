...
private:
	...
	{
		{EStellarClass::HyperGiant, FStarAttributeRanges({90000.0, 100000.0}, {100, 250}, {30, 1000}, {1.0e5, 1.0e6}, {-8.0, -10.0})}, // Hypergiant stars
		{EStellarClass::SuperGiant, FStarAttributeRanges({50000.0, 90000.0}, {8, 10}, {20, 500}, {1.0e6, 1.0e7}, {-4.0, -8.0})}, // Supergiant stars
		{EStellarClass::BrightGiant, FStarAttributeRanges({600, 5000}, {5, 8}, {10, 20}, {1.0e10, 1.0e12}, {-2.0, -5.0})}, // Red Dwarf stars
		{EStellarClass::Giant, FStarAttributeRanges({10.0, 1000.0}, {0.5, 10.0}, {10.0, 100.0}, {1.0e8, 1.0e9}, {0.0, 0.0})}, // Giant stars
		{EStellarClass::SubGiant, FStarAttributeRanges({10.0, 1000.0}, {0.5, 10.0}, {10.0, 100.0}, {1.0e8, 1.0e9}, {0.0, 0.0})}, // Giant stars
		{EStellarClass::MainSequence, FStarAttributeRanges({0.01, 100.0}, {0.08, 100.0}, {0.08, 10.0}, {1.0e7, 1.0e10}, {0.0, 0.0})}, // Main Sequence stars
		{EStellarClass::SubDwarf, FStarAttributeRanges({0.01, 1.0}, {0.1, 0.8}, {0.1, 0.8}, {1.0e9, 1.0e10}, {0.0, 0.0})}, // Subdwarf stars
